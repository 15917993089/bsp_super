...
static int input_dev_demo_probe(struct platform_device *pdev)
{
	...
	__set_bit(ABS_MT_SLOT, g_input_dev->absbit);//多点位移
	...
	/* hardware opration */
	//在设备树里注册了中断，所以我们能从platform_device平台设备获得中断资源
...
static struct platform_driver input_dev_demo_driver = {//注册了一个platform_driver
